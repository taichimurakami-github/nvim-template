...
require('lazy').setup({
  ...
  require 'defaults.plugins.vim-sleuth',

  require 'defaults.plugins.telescope',

  -- LSP Plugins
  require 'defaults.plugins.lazydev',

  require 'defaults.plugins.luvit-meta',

  require 'defaults.plugins.nvim-lspconfig',

  -- Autoformat
  require 'defaults.plugins.confirm',

  -- Autocompletion
  require 'defaults.plugins.nvim-cmp',

  -- colorscheme
  require 'defaults.plugins.tokyonight',

  -- Highlight todo, notes, etc in comments
  require 'defaults.plugins.todo-comments',

  -- Collection of various small independent plugins/modules
  require 'defaults.plugins.mini',

  -- Highlight, edit, and navigate code
  require 'defaults.plugins.nvim-treesitter',
